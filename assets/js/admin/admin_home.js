...
document.getElementById('generatePDFReportBtn').addEventListener('click', function () {
        ...
        return new Promise((resolve) => {
            ...
            if (canvas) {
                html2canvas(canvas).then((canvasImage) => {
                    ...
                    checkPageLimit();
                    pdf.addImage(imgData, 'PNG', 20, currentYPosition, width, height);
    ...
    const sections = [
        { title: 'Sales Statistic', subtitle: 'Average Price of Purchased Products', canvasId: 'averagePriceChart' },
                    { title: '', subtitle: 'Best-Selling Products', canvasId: 'bestSellersChart' },
                    { title: '', subtitle: 'Best-Selling Products by Celebrity', canvasId: 'bestSellingChart' },
                    { title: 'Customer Feedback Statistic', subtitle: 'Question 1', canvasId: 'q1Chart' },
                    { title: '', subtitle: 'Question 2', canvasId: 'q2Chart' },
                    { title: '', subtitle: 'Question 3', canvasId: 'q3Chart' },
                    { title: '', subtitle: 'Question 4', canvasId: 'q4Chart' },
                    { title: '', subtitle: 'Question 5', canvasId: 'q5Chart' },
                    { title: '', subtitle: 'Question 6', canvasId: 'q6Chart' },
                    { title: '', subtitle: 'Question 7', canvasId: 'q7Chart' },
                    { title: '', subtitle: 'Question 8', canvasId: 'q8Chart' },
                    { title: 'Most Popular Celebrity', subtitle: 'Popularity of Celebrity Hashtags Based on User-Created Rooms', canvasId: 'popularityChart' },
                    { title: '', subtitle: 'Most Liked Posts', canvasId: 'likedPostsChart' },
                    { title: '', subtitle: 'Most Commented Posts', canvasId: 'commentedPostsChart' },
        // Add more sections as needed with specific dimensions
    ];
    ...
    async function generateReport() {
        for (let section of sections) {
            ...
            pdf.text(section.title, 20, currentYPosition);
            currentYPosition += 20;

            if (section.subtitle) {
                pdf.setFontSize(12);
                pdf.setFont("helvetica", "normal");
                pdf.text(section.subtitle, 20, currentYPosition);
                currentYPosition += 20;
            }

            // Pass the specific width and height for each canvas
...
document.getElementById('generatePDFReportBtn').addEventListener('click', function () {
    ...
    const sections = [
                    ...
                    { title: 'Customer Feedback Statistic', subtitle: 'Question 1', canvasId: 'q1Chart', width: 200, height: 180 },
                    { title: '', subtitle: 'Question 2', canvasId: 'q2Chart', width: 200, height: 180 },
                    { title: '', subtitle: 'Question 3', canvasId: 'q3Chart', width: 200, height: 180 },
                    { title: '', subtitle: 'Question 4', canvasId: 'q4Chart', width: 200, height: 180 },
                    { title: '', subtitle: 'Question 5', canvasId: 'q5Chart', width: 200, height: 180 },
                    { title: '', subtitle: 'Question 6', canvasId: 'q6Chart', width: 200, height: 180 },
                    { title: '', subtitle: 'Question 7', canvasId: 'q7Chart', width: 200, height: 180 },
                    { title: '', subtitle: 'Question 8', canvasId: 'q8Chart', width: 200, height: 180 },
