  ...
  var EmojiMenu = function(emojiarea) {
    ...
    this.$categoryTabs = $(
        '<table class="emoji-menu-tabs"><tr>'
            + '<td><a class="emoji-menu-tab icon-recent" ><i class="far fa-clock"></i></a></td>'
            + '<td><a class="emoji-menu-tab icon-smile" ><i class="far fa-smile"></i></a></td>'
            + '<td><a class="emoji-menu-tab icon-flower"><i class="fab fa-pagelines"></i></a></td>'
            + '<td><a class="emoji-menu-tab icon-bell"><i class="fas fa-bell"></i></a></td>'
            + '<td><a class="emoji-menu-tab icon-car"><i class="fas fa-car"></i></a></td>'
            + '<td><a class="emoji-menu-tab icon-grid"><i class="fas fa-hashtag"></i></a></td>'
