...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = mysqli_query($conn, "SELECT * FROM admins WHERE email = '$email'"); // Change to your admin table
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        $updateQuery = mysqli_query($conn, "UPDATE admins SET password = '$hashedPassword' WHERE email = '$email'"); // Change to your admin table
